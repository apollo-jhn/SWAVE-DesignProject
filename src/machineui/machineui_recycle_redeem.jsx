...
export function MachineUI_Recycle_Redeem() {
    ...
    const navigateToThankYou = () => {
        navigate("/machineui/thankyou", {
            state: {
                message: apiResponse?.message || "Points were added to your account successfully.",
            },
        });
    };
    ...
    const handleRedeem = async () => {
        ...
        try {
            ...
            const data = await postRequest("/function/call", {
                function: "add_points",
                code: codeString,
            });
            ...
            // Immediately navigate if successful
